...
chromedriver_location = "C://Users//Oli//Downloads//chromedriver_win32//chromedriver.exe"
...
driver.find_element_by_xpath(enter_address_xpath).send_keys('11 Brick Drive')
driver.find_element_by_xpath(search_button_xpath).click()


driver.implicitly_wait(30)

next_bin = driver.find_element_by_xpath(next_bin_xpath).text
next_next_bin = driver.find_element_by_xpath(next_next_bin_xpath).text
